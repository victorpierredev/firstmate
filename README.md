...
| `/initiative`      | Start, continue, check, or close an Obsidian initiative through Firstmate, keeping human plans read-only and publishing separate progress notes |
